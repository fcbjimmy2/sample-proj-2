...
import OperationTabs from './tabs';
...
const SalesInvoices = () => {
  ...
  const statuses = ['pending', 'completed', 'void'];
  ...
  return (
    <>
      <MainCard title={intl.formatMessage({ id: 'Invoices' })} boxShadow>
...
SalesInvoices.getLayout = function getLayout(page) {
