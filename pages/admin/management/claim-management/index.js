...
const ClaimManagement = () => {
    ...
    return (
        <MainCard title={intl.formatMessage({id: 'claim-management'})} boxShadow>
            <Tabs
                value={tab}
                variant="scrollable"
            ...
            <TabPanel key={3} value={tab} index={3}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <DatePicker id="end-date" name="end-date" label={intl.formatMessage({id: 'end-date'})} />
                    </Grid>
                    <Grid item>
...
ClaimManagement.getLayout = function getLayout(page) {
    return (
        <AdminLayout>
            {page}
        </AdminLayout>
