...
export default function MailItemAction({
  ...
  const actions = [
    ...
    { name: intl.formatMessage({id: 'Mail-Delete'}), icon: 'eva:trash-2-outline', action: onDelete },
    { name: intl.formatMessage({id: 'Mail-Mark Email Read'}), icon: 'ic:round-mark-email-read', action: onMarkRead },
