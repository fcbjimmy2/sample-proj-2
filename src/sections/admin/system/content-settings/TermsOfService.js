...
const TermsOfService = ({ data, handleEnModelChange, handleZhHantModelChange, handleZhHansModelChange }) => {
    const intl = useIntl();

    const config = {
        htmlAllowedTags: ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'a', 'table', 'strong'],
        htmlAllowedAttrs: ['href', 'style'],
    ...
    return (
        <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
                ...
                <FroalaEditorComponent 
                    model={data.termsOfService.zh_Hant}
            ...
            <Grid item xs={12}>
                ...
                <FroalaEditorComponent 
                    model={data.termsOfService.zh_Hans}
