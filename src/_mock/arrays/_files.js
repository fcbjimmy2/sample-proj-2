...
//   const folderRes = fetch("/api/folders")
//     .then((response) => response.json())
//     .then((res) => {
//       return res;
//     });

//   const fileRes = fetch("/api/files")
//     .then((response) => response.json())
//     .then((res) => {
//       return res;
//     });

//     const folders = await folderRes;
//     const files = await fileRes;
//     return [...folders, ...files];
//   // const res2 = await axios.get('/api/files');
// }

// export const _allFiles2 = getAllFiles();
