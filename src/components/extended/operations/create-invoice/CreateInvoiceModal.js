...
//modals
import StudentListModal from '../student-list-table/StudentListModal';
...
const Body = React.forwardRef(
  (
    ...
    <div ref={ref} tabIndex={-1}>
        ...
        >
          ...
          >
            ...
            <TextField
              ...
              margin="normal"
              fullWidth
              onClick={() => handleOpenGetStudentModal(condition)}
            />
            <TextField
              InputProps={{
                readOnly: true,
      ...
      />
      <ItemList handleClose={handleCloseAddItem} open={openAddItem} setRows={setRows} />
      <MessageModal
...
export default function CreateInvoiceModal({
  ...
  React.useEffect(() => {
    console.log(studentInvoiceDetails);
  }, []);
  console.log(studentInvoiceDetails);
  //Get Student List Modal
  const handleOpenGetStudentModal = (condition) => {
    if (condition !== 'course-enrollment') setOpenGetStudentModal(true);
    return;
  };
